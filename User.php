        ...
        <div class="form">
            <div class="row">
                <div class="column left">
                    ...
                    <input type="text" class="form-control" id="Cname" name="Cname[]" value="" placeholder="Customer Name" required>
                </div>
                ...
                <div class="column right">
                    ...
                    <input type="number" class="form-control" id="mobile" value="" name="mobile[]"placeholder="Mobile" required>
                </div>
            </div>
            <div class="itemContainer">
                <div class="row item">
                    <div class="column left">
                        ...
                        <select type = "text" class="form-control grocery" id="grocery" value="" name="grocery[]"placeholder="Grocery" required>
                            <option value="">Select Items</option></select>
                    </div>
                    <div class="column middle">
                    ...
                    <div class="column right">
                        ...
                        <select type="Number" class="form-control rate" id="rate" value="" name="rate[]"
                            placeholder="Rate" required><option value="">Select Items</option></select>
                    </div>
                    <div class="column right">
                        <label for="Total" class="form-label">Total:</label>
                        <input type="Number" class="form-control total" id="total" value="" placeholder="Total"
                            required>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#Additem').on('click', function(){
            $('.itemContainer').append('<div class="row item"><div class="column left">\
                ...
                <div class="column right">\
                    <label for="total" class="form-label">Total:</label>\
                    <input type="Number" class="form-control total" id="total" value="" placeholder="Total" required>\
                </div>\
                ...
                if(grocery_id){                                   //If grocery id exist.
                    $.ajax({                                     //ajax start
                        ...
                        success: function(data){      //Retrieving data
                          $(this).closest('.item').find('.rate').html(data); //Show the data to Rate via Class
                        }.bind(this),
        ...
        $('#invoiceForm').on('submit', function(e){ //Prevent the form from submitting
            ...
            //Gather All Grocery,quantity and rate values
            /* var Grocery = [];
            var Quantity = [];
            var Rate = [];
            

            $('.grocery').each(function() {
                var grocery = Grocery.push($(this).val());
                console.log(grocery);
            });
            $('.quantity').each(function() {
                var quantity = Quantity.push($(this).val());
            });
            $('.rate').each(function() {
                var rate = Rate.push($(this).val());
            });  */
